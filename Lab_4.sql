...
on primary
( 
	name = N'SHU_UNIVER_mdf', 
	filename = N'C:\Projs\DB\SHU_UNIVER.mdf',
	size = 5Mb, 
	maxsize=10Mb, 
	filegrowth=1Mb
),
( 
	name = N'SHU_UNIVER_ndf', 
	filename = N'C:\Projs\DB\SHU_UNIVER.ndf',
	size = 5Mb, 
	maxsize=10Mb, 
	filegrowth=10%
),
filegroup G1
( 
	name = N'SHU_UNIVER11_ndf_ndf', 
	filename = N'C:\Projs\DB\SHU_UNIVER11.ndf',
	size = 10Mb, 
	maxsize=15Mb, 
	filegrowth=1Mb
),
( 
	name = N'SHU_UNIVER12_ndf', 
	filename = N'C:\Projs\DB\SHU_UNIVER12.ndf',
	size = 2Mb,
	maxsize=5Mb,
	filegrowth=1Mb
),
filegroup G2
(
	name = N'SHU_UNIVER21_ndf',
	filename = N'C:\Projs\DB\SHU_UNIVER21.ndf',
	size = 5Mb,
	maxsize = 10Mb,
	filegrowth = 1Mb
),
(
	name = N'SHU_UNIVER22_ndf',
	filename = N'C:\Projs\DB\SHU_UNIVER22.ndf',
	size = 2Mb,
	maxsize = 5Mb,
	filegrowth = 1Mb
)
...
( 
	name = N'UNIVER_log', 
	filename=N'C:\Projs\DB\UNIVER_log.ldf', 
	size=10240Kb, 
	maxsize=2048Gb, 
	filegrowth=10%
)
...
( 
	...
	AUDITORIUM_TYPE char(10) constraint AU_AUDITORIUM_TYPE_FK foreign key references AUDITORIUM_TYPE(AUDITORIUM_TYPE), 
	AUDITORIUM_CAPACITY integer constraint AU_CAPACITY_CHECK default 1 check (AUDITORIUM_CAPACITY between 1 and 300),
	AUDITORIUM_NAME nvarchar(50) 
) on G2;


insert into AUDITORIUM (AUDITORIUM, AUDITORIUM_NAME, 
AUDITORIUM_TYPE, AUDITORIUM_CAPACITY)  values 
				('206-1', '206-1','ЛБ-К', 15),
				('301-1', '301-1', 'ЛБ-К', 15),
				('236-1', '236-1', 'ЛК', 60),
				('313-1', '313-1', 'ЛК-К', 60),
